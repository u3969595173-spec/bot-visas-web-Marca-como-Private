        ...
        <div>
          ...
          <div style={{
            ...
            <h2 style={{
              ...
              Solicitud de Seguro Médico {estadoSeguro === 'aprobado' ? 'APROBADA' : 'RECHAZADA'}
            </h2>
            <p style={{
        ...
        <form onSubmit={manejarSubmit}>
          ...
          <div style={{
            ...
            <label style={{
              ...
              🏥 ¿Ya tienes seguro médico válido para España?
            </label>
            ...
            <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap', marginBottom: '20px' }}>
              ...
              <label style={{
                ...
                />
                <span style={{ fontWeight: '500', color: '#374151' }}>
                  ❌ No, necesito contratar uno
                </span>
              </label>
            </div>
          </div>

          {/* Si no tiene seguro, mostrar opciones de gestión */}
          {tieneSeguro === 'no' && (
            <div style={{
              marginBottom: '30px',
              padding: '25px',
          ...
          <div style={{
            ...
            <textarea
              ...
              placeholder="Menciona si tienes condiciones médicas preexistentes, alergias, medicamentos que tomas, preferencias de cobertura, etc."
              rows="4"
              style={{
                width: '100%',
                padding: '12px',
