                  ...
                  <div>
                    ...
                    {tipoRetiro === 'p2p' ? (
                      ...
                      <div style={{ margin: '15px 0 0 0', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                        {/* CAMPOS DE DESTINO MOVIDOS AQUÍ (ARRIBA DE LA ALERTA) */}
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '10px' }}>
                          {(monedaRetiro || '').includes('USDT') ? (
                            <div>
                              <label htmlFor="wallet-retiro" style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '600', fontSize: '14px', color: '#f8fafc' }}>
                                Dirección de Billetera (Red externa compatible: TRC-20, BEP-20, ERC-20)
                              </label>
                              <input
                                id="wallet-retiro"
                                type="text"
                                ...
                                placeholder="0x..."
                                style={{ width: '100%', padding: '0.75rem', border: '1px solid rgba(0, 240, 255, 0.3)', borderRadius: '8px', fontSize: '14px', backgroundColor: 'rgba(0, 0, 0, 0.4)', color: 'white', boxSizing: 'border-box', outline: 'none' }}
                                required
                              />
                            </div>
                          ) : (
                            <>
                              <div>
                                <label htmlFor="iban-retiro" style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '600', fontSize: '14px', color: '#f8fafc' }}>
                              ...
                              <div>
                                <label htmlFor="titular-retiro" style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '600', fontSize: '14px', color: '#f8fafc' }}>
                                  Nombre del Titular
                                </label>
                                <input
                                  id="titular-retiro"
                        ...
                        {montoRetiro && Number(montoRetiro) > 0 && Number(montoRetiro) <= saldoRetirable && (
                          <div style={{ padding: '10px', backgroundColor: 'rgba(16, 185, 129, 0.08)', borderRadius: '6px', border: '1px dashed rgba(16, 185, 129, 0.3)' }}>
                            <p style={{ margin: 0, fontSize: '13px', color: '#34d399', fontWeight: '600', textAlign: 'center' }}>
                              ✅ Enviar a Billetera: {formatCurrency(Number(montoRetiro) * 0.95, monedaRetiro)}
                            </p>
                          </div>
                        )}
                      </div>
