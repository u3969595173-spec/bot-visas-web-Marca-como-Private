...
const NIVELES_COMUNIDAD = [
    { emoji: '🌱', nombre: 'Community', min: 5, max: 24, bonus: '25 USDT', color: '#4ade80' },
    { emoji: '⭐', nombre: 'Leader', min: 25, max: 49, bonus: '50 USDT', color: '#60a5fa' },
    { emoji: '🔥', nombre: 'Senior Leader', min: 50, max: 99, bonus: '100 USDT', color: '#ef4444' },
    { emoji: '💎', nombre: 'Elite Leader', min: 100, max: 199, bonus: '150 USDT', color: '#c084fc' },
    { emoji: '👑', nombre: 'Executive Leader', min: 200, max: 499, bonus: '250 USDT', color: '#fb923c' },
    { emoji: '🏆', nombre: 'Founding Leader', min: 500, max: null, bonus: '400 USDT', color: '#f6c453' },
];
            ...
            <div style={{ background: 'linear-gradient(135deg, #2a0845, #6441A5)', borderBottom: '2px solid #ef4444', padding: '3rem 1.5rem 2rem' }}>
                <div style={{ maxWidth: 900, margin: '0 auto' }}>
                    ...
                    <p style={{ margin: 0, color: '#cbd5e1', fontSize: '1.05rem', maxWidth: 700, lineHeight: 1.6 }}>
                        ...
                        <strong> Ambas modalidades pueden combinarse.</strong> El beneficio mensual correspondiente al capital se mantiene y, al desarrollar una comunidad, puedes desbloquear bonificaciones únicas adicionales.
                    </p>
                </div>
            </div>
            ...
            <div style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1.5rem' }}>
                        ...
                        <div style={{ background: 'rgba(15,23,42,0.8)', border: '1px solid rgba(148,163,184,0.1)', borderRadius: 14, padding: '2rem' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
                                ...
                                <div style={{ background: 'rgba(167, 139, 250, 0.05)', border: '1px solid rgba(167, 139, 250, 0.2)', padding: '1.5rem', borderRadius: 12 }}>
                                    ...
                                    <p style={{ margin: 0, color: '#94a3b8', fontSize: '0.95rem', lineHeight: 1.6 }}>Construye una red de inversores y recibe un Bonus Único directo cada vez que desbloquees un nuevo hito de miembros activos.</p>
                                </div>
                            </div>
                            ...
                            <div style={{ marginTop: '1.5rem', background: 'rgba(239, 68, 68, 0.05)', border: '1px solid rgba(239, 68, 68, 0.3)', padding: '1.5rem', borderRadius: 12 }}>
                                ...
                                <p style={{ margin: 0, color: '#e2e8f0', textAlign: 'center', lineHeight: 1.6 }}>
                                    Puedes mantener tu nivel de capital y, al mismo tiempo, desarrollar una comunidad. El beneficio mensual del capital se mantiene y los bonus de comunidad se reciben como recompensas únicas por cada nuevo nivel.
                                </p>
                            </div>
                        </div>
                ...
                {tab === 'comunidad' && (
                    <div>
                        ...
                        <p style={{ color: '#94a3b8', marginBottom: '2rem' }}>Si además decides crear una comunidad, puedes desbloquear bonificaciones únicas de capital al alcanzar cada nuevo nivel de red activa.</p>
                                ...
                                <div key={n.nombre} style={{ background: 'rgba(15,23,42,0.8)', border: `1px solid ${n.color}33`, borderLeft: `6px solid ${n.color}`, borderRadius: 10, padding: '1.2rem 1.5rem' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.8rem' }}>
                                        ...
                                        <div style={{ textAlign: 'right', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '4px' }}>
                                            <span style={{ fontSize: 10, color: '#f8fafc', background: 'rgba(255,255,255,0.1)', padding: '2px 6px', borderRadius: 4, letterSpacing: '0.05em' }}>BONUS ÚNICO</span>
                ...
                <div style={{ background: 'transparent', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '1.5rem', marginTop: '2rem' }}>
                    <ul style={{ margin: 0, padding: 0, color: '#64748b', fontSize: '0.8rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', listStyle: 'none' }}>
                        ...
                        <li>* Los bonus de comunidad son pagos únicos asociados al desbloqueo de cada nivel.</li>
