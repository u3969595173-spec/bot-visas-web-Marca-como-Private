...
const NIVELES = [
  { emoji: '🌱', nombre: 'Community',        min: 5,   max: 24,  cupo: '2%',  beneficio: '25 USDT/mes',  color: '#4ade80', ejemplo: { usdt: 200,   benef: 60 } },
  { emoji: '⭐', nombre: 'Leader',           min: 25,  max: 49,  cupo: '5%',  beneficio: '50 USDT/mes',  color: '#facc15', ejemplo: { usdt: 500,   benef: 150 } },
  { emoji: '🔥', nombre: 'Senior Leader',    min: 50,  max: 99,  cupo: '10%', beneficio: '100 USDT/mes', color: '#fb923c', ejemplo: { usdt: 1000,  benef: 300 } },
  { emoji: '💎', nombre: 'Elite Leader',     min: 100, max: 199, cupo: '15%', beneficio: '150 USDT/mes', color: '#60a5fa', ejemplo: { usdt: 1500,  benef: 450 } },
  { emoji: '👑', nombre: 'Executive Leader', min: 200, max: 499, cupo: '25%', beneficio: '250 USDT/mes', color: '#c084fc', ejemplo: { usdt: 2500,  benef: 750 } },
  { emoji: '🏆', nombre: 'Founding Leader',  min: 500, max: null, cupo: '43%', beneficio: '400 USDT/mes', color: '#f6c453', ejemplo: { usdt: 4300,  benef: 1290 } },
];
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '2rem 1.5rem' }}>
        ...
        {tab === 'niveles' && (
          <div>
                ...
                <div key={n.nombre} style={{ background: 'rgba(15,23,42,0.8)', border: `1px solid ${n.color}33`, borderLeft: `4px solid ${n.color}`, borderRadius: 14, padding: '1.4rem 1.5rem' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '0.5rem' }}>
                    ...
                    <div style={{ textAlign: 'right' }}>
                      ...
                      <div style={{ fontSize: 13, color: '#94a3b8', marginTop: 2 }}>{n.beneficio} durante 2 meses</div>
                    </div>
                  </div>
            ...
            <p style={{ fontSize: 12, color: 'rgba(148,163,184,0.4)', marginTop: '1.5rem' }}>* Los cupos son máximos y están sujetos a las condiciones y disponibilidad de cada operación. Los beneficios mensuales son temporales y están sujetos a las condiciones del programa.</p>
          </div>
        )}
