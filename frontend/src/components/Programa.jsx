...
const BENEFICIOS = [
  ...
  'Apoyo promocional',
  'Patrocinios',
  'Colaboraciones con Capital Iberia',
  ...
  return (
    <div style={{ background: '#050d18', minHeight: '100vh', fontFamily: 'Inter, sans-serif', color: '#f1f5f9' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '2rem 1.5rem' }}>
        ...
        {tab === 'niveles' && (
          <div>
            <p style={{ color: '#94a3b8', marginBottom: '1.5rem' }}>En Capital Iberia creemos que una comunidad fuerte genera más oportunidades. Cada líder puede construir su propia comunidad y desbloquear progresivamente beneficios, promociones y mayor capacidad de participación.</p>
        ...
        <div style={{ background: 'rgba(15,23,42,0.9)', border: '2px solid rgba(246,196,83,0.3)', borderRadius: 16, padding: '2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1.5rem' }}>
          <div>
            ...
            <p style={{ margin: 0, color: '#94a3b8', fontSize: 14, maxWidth: 440 }}>
              Contacta con Capital Iberia y te habilitamos tu propio panel de control de comunidad con acceso a todas las herramientas de gestión.
            </p>
          </div>
          <a href="mailto:contacto@capitaliberia.com" style={{ background: 'linear-gradient(135deg, #f6c453, #dba93a)', color: '#0a0f1a', textDecoration: 'none', padding: '0.9rem 2rem', borderRadius: 12, fontWeight: 800, fontSize: 15, whiteSpace: 'nowrap', display: 'inline-block' }}>
