...
function TorneosDomino({ admin = false }) {
  ...
  const [formulario, setFormulario] = React.useState({ nombre: '', min_parejas: 4, costo_inscripcion: 0, premio_primero: 0, premio_segundo: 0, premio_tercero: 0 })
